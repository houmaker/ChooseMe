import 'package:cma/local_notifications_helper.dart';
import 'package:cma/page/thrid_page.dart';
...
class _LocalNotificationWidgetState extends State<LocalNotificationWidget> {
  ...
  Future onSelectNotification(String payload) async => await Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => ThridPage(payload: payload)),
      );
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: ListView(
          children: <Widget>[
            ...
            const SizedBox(height: 32),
            RaisedButton(
              child: Text('Scheduling notification'),
              onPressed: () => showScheduleOngoingNotification(
                    notifications,
                    title: 'IconAndImageTitle',
                    body: 'IconAndImageBody',
                    id: 40,
