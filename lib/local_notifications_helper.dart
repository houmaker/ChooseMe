...
//Schedule
NotificationDetails get _onschedulegoing {
  final androidPlatformChannelSpecifics = AndroidNotificationDetails(
...
Future showScheduleOngoingNotification(
  FlutterLocalNotificationsPlugin notifications, {
  @required String title,
  @required String body,
  int id = 0,
}) =>
    _showScheduleNotification(notifications,
        title: title,
        body: body,
        id: id,
        scheduledDate: DateTime.now().add(new Duration(seconds: 10)),
        type: _onschedulegoing);
